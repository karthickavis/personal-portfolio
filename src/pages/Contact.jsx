...
export default function Contact() {
  return (
    <section id="contact" className="bg-[#0f172a] text-white py-10 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col justify-center bg-[#1e293b] p-8 rounded-lg shadow-md text-gray-300">
            ...
            <p><span className="font-semibold">📧 Email:</span> karthisiva292@gmail.com</p>
            <p><span className="font-semibold">📞 Phone:</span> +91 6383583186</p>
